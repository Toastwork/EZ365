...
Le certificat vaut pour **tous** les clients : rien n'est a deposer chez eux.
Un nouveau client accepte la permission d'office en se connectant.

La page du certificat liste chaque client avec l'etat de son acces SharePoint
(`operationnel`, `consentement a renouveler`, `certificat non depose`) et un
bouton « Renouveler » qui ouvre directement l'ecran de consentement du
client. La fiche d'un client affiche le meme avertissement tant que la
creation des OneDrive n'y est pas possible.
